      ...
      <Card style={{ background: 'rgba(250,204,21,0.05)', borderColor: 'rgba(250,204,21,0.2)' }}>
        {RACE_DINNER.map((item, i) => (
          <div
            ...
            style={{
              padding: '7px 0',
              borderBottom: i < RACE_DINNER.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
      ...
      <Card style={{ background: 'rgba(248,113,113,0.05)', borderColor: 'rgba(248,113,113,0.2)' }}>
        {RACE_MORNING.map((item, i) => (
          <div
            ...
            style={{
              padding: '8px 0',
              borderBottom: i < RACE_MORNING.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
      ...
      <Card>
        {SUPPLEMENTS.map((s, i) => (
          <div
            ...
            style={{
              padding: '10px 0',
              borderBottom: i < SUPPLEMENTS.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
            }}
          >
