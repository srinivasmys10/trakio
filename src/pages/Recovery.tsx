      ...
      <Card>
        {WARMUP_STEPS.map((step, i) => (
          <div
            ...
            style={{
              padding: '8px 0',
              borderBottom: i < WARMUP_STEPS.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
              display: 'flex',
              gap: 10,
      ...
      <Card>
        {COOLDOWN_STEPS.map((step, i) => (
          <div
            ...
            style={{
              padding: '8px 0',
              borderBottom: i < COOLDOWN_STEPS.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
              display: 'flex',
              gap: 10,
              alignItems: 'flex-start',
            }}
      ...
      <Card style={{ background: 'rgba(96,165,250,0.05)', borderColor: 'rgba(96,165,250,0.2)' }}>
        {REST_TIPS.map((item, i) => (
          <div
            ...
            style={{
              padding: '8px 0',
              borderBottom: i < REST_TIPS.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
